            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('bus-management')}}">
                                <i class="ni ni-archive-2 text-primary"></i>
                                <span class="nav-link-text">Bus Management</span>
                            </a>
                        </li>
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="{{url('route-management')}}">
                                <i class="ni ni-archive-2 text-primary"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse show" id="route-price">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{url('route-management')}}" class="nav-link">New Route</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('route_price')}}" class="nav-link">Route & Pricing</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse show" id="navbar-dashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{url('reservation-management')}}" class="nav-link">New Reservations</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{url('approved-reservations')}}" class="nav-link">Approved Reservations</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{url('rejected-reservations')}}" class="nav-link">Rejected Reservations</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('city-management')}}">
                                <i class="ni ni-archive-2 text-primary"></i>
