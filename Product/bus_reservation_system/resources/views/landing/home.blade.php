   ...
   <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a class="mr-5 hover:text-gray-900"><a href="/my-reservation">My Booking</a>
        </a>
            <a class="mr-5 hover:text-gray-900"><a href="/register">Sign up</a>
        </a>
            <a class="mr-5 hover:text-gray-900"><a href="/login">Log In</a>
        </a>
            <a class="mr-5 hover:text-gray-900"><a></a>
        </a>
         
          </nav>
          <a href="mailto:jaiswal.bus.servises@gmail.com">
          <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0" ><a href="mailto:jaiswal.bus.servises@gmail.com">Contact US</a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <!-- 1st line: get the start city price
                    2nd get the destination city price
                3rd line calculate the price
                167: calculate the available seat  -->
                                          ...
                                          <div class="container px-5 py-24 mx-auto">
                                            ...
                                            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                                              ...
                                              <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
                                                ...
                                                <img src="/Images/bus_f.png" alt="Italian Trulli">
